...
* getLineFILEorSTDIN :: get line string
 */
...
// THis is kill all process or just one processor
...
// get Command from token and line --> it will active on execvp
